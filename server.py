...
from src.settings.config import color
...
def esperar(tcp, send, host='', port=5000):
    ...
    while True:
        ...
        print(cliente)
        print(color.YELLOW, cliente, color.END)
...
if __name__ == '__main__':
    ...
    print(color.DARKCYAN + 'Iniciando o servidor de chat!' + color.END)
    print(color.DARKCYAN + 'Aguarde alguém conectar!' + color.END)
